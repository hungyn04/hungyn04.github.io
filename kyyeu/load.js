...
function addContent(json) {
  ...
  let elm = (l1, l2, l3, nm, dc, lr) => `<section><div class="clt"><img src="${l1}" /><img src="${l2}" /><img src="${l3}" /></div><div class="des"><h1>${nm}</h1><p>${dc}</p><button onclick="window.open('${lr}')"><span>Xem ngay và luôn</span><img src="./res/arrow.svg" /></button></div><div class="line"></div></section>`;
